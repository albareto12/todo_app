...
Estado actual
- Este README y el .gitignore están creados ahora.
- El resto del proyecto (infra, backend, frontend, tests, integración LLM) se irá documentando aquí conforme vayamos construyendo cada micro‑paso.
...
- [ ] 0. Preparar repo y entorno local  
  ...
  - Aquí agregaré los comandos exactos y comprobaciones cuando estés listo.

- [ ] 1. Infra con Docker (Postgres + smtp4dev + contenedor web esqueleto)  
  ...
  - Contenido y comandos se añadirán cuando me autorices a crear los archivos.

- [ ] 2. Scaffolding del backend (estructura y requirements)  
  ...
  - Detallaré cada archivo y su propósito cuando quieras empezar a crearlo.
